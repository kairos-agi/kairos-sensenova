...
from ..dits import sinusoidal_embedding_1d
from ..vaes import WanVideoVAE
from ..text_encoders import QwenVLTextEncoder
from ..schedulers.flow_match import FlowMatchScheduler

from kairos.pipelines.builder import KAIROS_PIPELINES


@KAIROS_PIPELINES.register_module()
class KairosVideoPipeline(BasePipeline):
    ...
    def from_pretrained(
        ...
        # ***********************************************************
        # Initialize pipeline
        pipe = KairosVideoPipeline(device=device, torch_dtype=torch_dtype)
        ...
        print(f'loading KairosVideoPipeline done .')
        return pipe
...
class WanVideoUnit_ShapeChecker(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, height, width, num_frames):
...
class WanVideoUnit_NoiseInitializer(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, input_video, height, width, num_frames, seed, rand_device, vace_reference_image):
...
class WanVideoUnit_InputVideoEmbedder(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, input_video, noise, tiled, tile_size, tile_stride, vace_reference_image):
...
class WanVideoUnit_ImageEmbedder(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, input_image, end_image, num_frames, height, width, tiled, tile_size, tile_stride):
...
class WanVideoUnit_ImageEmbedderCLIP(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, input_image, end_image, height, width):
...
class WanVideoUnit_ImageEmbedderFused(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, input_image, latents, height, width, tiled, tile_size, tile_stride):
...
class WanVideoUnit_FunControl(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, control_video, num_frames, height, width, tiled, tile_size, tile_stride, clip_feature, y, latents):
...
class WanVideoUnit_FunReference(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, reference_image, height, width):
...
class WanVideoUnit_FunCameraControl(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, height, width, num_frames, camera_control_direction, camera_control_speed, camera_control_origin, latents, input_image, tiled, tile_size, tile_stride):
...
class WanVideoUnit_SpeedControl(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, motion_bucket_id):
...
class WanVideoUnit_UnifiedSequenceParallel(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline):
...
class WanVideoUnit_TeaCache(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, num_inference_steps, tea_cache_l1_thresh, tea_cache_model_id):
...
class WanVideoUnit_CfgMerger(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, inputs_shared, inputs_posi, inputs_nega):
...
class WanVideoUnit_S2V(PipelineUnit):
    ...
    def process_audio(self, pipe: KairosVideoPipeline, input_audio, audio_sample_rate, num_frames, fps=16, audio_embeds=None, return_all=False):
    ...
    def process_motion_latents(self, pipe: KairosVideoPipeline, height, width, tiled, tile_size, tile_stride, motion_video=None):
        pipe.load_models_to_device(["vae"])
        motion_frames = 73
        kwargs = {}
    ...
    def process_pose_cond(self, pipe: KairosVideoPipeline, s2v_pose_video, num_frames, height, width, tiled, tile_size, tile_stride, s2v_pose_latents=None, num_repeats=1, return_all=False):
    ...
    @staticmethod
    def pre_calculate_audio_pose(pipe: KairosVideoPipeline, input_audio=None, audio_sample_rate=16000, s2v_pose_video=None, num_frames=81, height=448, width=832, fps=16, tiled=True, tile_size=(30, 52), tile_stride=(15, 26)):
...
class WanVideoPostUnit_S2V(PipelineUnit):
    ...
    def process(self, pipe: KairosVideoPipeline, latents, motion_latents, drop_motion_frames):
