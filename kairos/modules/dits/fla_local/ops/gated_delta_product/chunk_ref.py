...
from kairos.modules.dits.fla_local.ops.delta_rule import chunk_delta_rule
from kairos.modules.dits.fla_local.ops.gated_delta_rule import chunk_gated_delta_rule
