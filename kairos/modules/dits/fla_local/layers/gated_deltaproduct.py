...
from kairos.modules.dits.fla_local.ops.gated_delta_product import chunk_gated_delta_product
from kairos.modules.dits.fla_local.ops.gated_delta_rule import fused_recurrent_gated_delta_rule
