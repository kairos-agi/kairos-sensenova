    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.tp_num_splits > 1:
            ...
            # assert tp_num_splits == self.tp_size
            assert hidden_size % tp_num_splits == 0
            self.shard = hidden_size // tp_num_splits
    ...
    def forward(
        ...
        **kwargs,
        ...
        return causal_conv1d(
            x=x,
            weight=rearrange(self.weight[start:end], "d 1 w -> d w"),
            bias=self.bias,
            residual=residual,
            initial_state=cache,
            output_final_state=output_final_state,
